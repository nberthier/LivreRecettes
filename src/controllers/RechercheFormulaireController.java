...
public class RechercheFormulaireController implements Initializable {
    ...
    public void valider(){
        try{
            ...
            main.popup("Erreur remplissage", "Les champs durees doivent etre remplis avec un nombre.", "Veuillez rentrer un entier dans les champs de durées exprimées en minutes", true);
        }
    }
